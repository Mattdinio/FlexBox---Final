...
public abstract class Box {
    ...
    /**
     * Accessor method to get the quantity of the box to find out how many of this box exists
    ...
    /**
     * Accessor method to calculate the cost which all subclasses inherit
