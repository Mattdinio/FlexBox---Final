...
public class UserInterface extends javax.swing.JFrame {
    ...
    public void addType(Integer type, Integer grade, Integer colour, boolean rb, boolean rc,
        ...
        //add the cost to the array of costs after the iteration of quantity
        //DecimalFormat totalCost = new DecimalFormat("#.00"); 
    ...
    public void getCostOfBoxes(ArrayList list) {
        ...
        //round the cost to two decimal place
    ...
    private void RemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RemoveActionPerformed
        ...
        if (run) {
            //we want to remove the last box and quantity inserted in the array 
    ...
    private void ClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ClearActionPerformed
        ...
        //ADD ONE BOX AND REMOVE IT WITH CLEAR AN EXCEPTION COMES UP - FIX IT
        if (run) {
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        if (type != -19 && quantity > 0) {
            ...
            Double boxCost = (boxArray.get(boxArray.size() - 1).getCost()) * quantity;
            boxCost = (double) (Math.round(boxCost * 100)) / 100;
    ...
    private void deleteSelectedBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteSelectedBoxActionPerformed
        ...
        //delete a selected input then click the delete input
        try{
        ...
        if(run && SelectedRowIndex != -19) {
            ...
            //removal of the box and cost in the correct position
